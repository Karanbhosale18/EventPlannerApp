...
public class venue_1 extends AppCompatActivity {
Button url1,btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                gotoUrl("https://vitthalmangalam.com/");
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (m.length() == 10 && Email.matches(EmailValidation) && Firstname!=null && Lastname!=null && Address!=null) {
                    ...
                    int amount=15999*Integer.parseInt(item);
                    String msg = ("DEAR "+Firstname+" "+Lastname+","+"\nYOUR BOOKING IS CONFIRMED\nBOOKING OTP IS : "+no+"\nBOOKING HOURS : "+item+"HR"+"\nEVENT TYPE : "+eventname+"\nTOTAL BILL : "+amount);
                    Intent i2 = new Intent();
                    PendingIntent pi = PendingIntent.getActivity(venue_1.this, 0, i2, PendingIntent.FLAG_IMMUTABLE);

                    SmsManager sms = SmsManager.getDefault();
                    sms.sendTextMessage(m, null, msg, pi, null);

                    Toast.makeText(venue_1.this, "VENUE BOOKED", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(venue_1.this,"INVALID INFORMATION",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
