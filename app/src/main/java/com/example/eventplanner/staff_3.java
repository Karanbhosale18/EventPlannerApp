...
public class staff_3 extends AppCompatActivity {
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_staff3);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int a=count*hours*999;

                if (m.length() == 10 && Email.matches(EmailValidation) && Firstname!=null && Lastname!=null && Address!=null) {
                    if (count <= 35) {
                        Random r = new Random();
                        no = r.nextInt(1000000);
                        String msg = ("DEAR " + Firstname + " " + Lastname + "," + "\nYOUR EMPLOYEES ARE BOOKED,\nYOUR OTP IS : " + no +"\nEMPLOYEE TYPE : TEMPORARY EMPLOYEES"+"\nREQUIRED EMPLOYEES : "+count+"\nTOTAL BILL : Rs. " + a);

                        Intent i2 = new Intent();
                        PendingIntent pi = PendingIntent.getActivity(staff_3.this, 0, i2, PendingIntent.FLAG_IMMUTABLE);

                        SmsManager sms = SmsManager.getDefault();
                        sms.sendTextMessage(m, null, msg, pi, null);

                        Toast.makeText(staff_3.this, "MESSAGE SEND SUCCESSFULLY", Toast.LENGTH_LONG).show();
                    }else {
                        Toast.makeText(staff_3.this,count+" EMPLOYEES ARE NOT AVAILABLE",Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(staff_3.this,"INVALID INFORMATION",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
