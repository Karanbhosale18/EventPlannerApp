...
public class food_8 extends AppCompatActivity {
    Button btn;
    Spinner spinner1;
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (m.length() == 10 && Email.matches(EmailValidation) && Firstname!=null && Lastname!=null && Address!=null) {
                    ...
                    PendingIntent pi = PendingIntent.getActivity(food_8.this, 0, i2, PendingIntent.FLAG_IMMUTABLE);

                    SmsManager sms = SmsManager.getDefault();
                    sms.sendTextMessage(m, null, msg, pi, null);

                    Toast.makeText(food_8.this, "MESSAGE SEND SUCCESSFULLY", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(food_8.this,"INVALID INFORMATION",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
