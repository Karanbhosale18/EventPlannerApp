...
public class staff_1 extends AppCompatActivity {
    Button btn;
            ...
            public void onClick(View view) {
                ...
                if (m.length() == 10 && Email.matches(EmailValidation) && Firstname!=null && Lastname!=null && Address!=null) {
                    if (count <= 35) {
                        ...
                        PendingIntent pi = PendingIntent.getActivity(staff_1.this, 0, i2, PendingIntent.FLAG_IMMUTABLE);

                        SmsManager sms = SmsManager.getDefault();
                        sms.sendTextMessage(m, null, msg, pi, null);

                        Toast.makeText(staff_1.this, "MESSAGE SEND SUCCESSFULLY", Toast.LENGTH_LONG).show();
                    }else {
                        Toast.makeText(staff_1.this,count+" EMPLOYEES ARE NOT AVAILABLE",Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(staff_1.this,"INVALID INFORMATION",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
